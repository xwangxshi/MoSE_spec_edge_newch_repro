...
class MLPLayer(nn.Module):
    def __init__(self, in_dim, out_dim, batch_norm=True, residual=True, dropout=0):
        super().__init__()
        self.in_channels = in_dim
        self.out_channels = out_dim
        self.batch_norm = batch_norm
        ...
        # note: batchnorm included in default MLP
        self.conv = MLP(channel_list = [in_dim, out_dim], dropout=[float(dropout)], norm=norm, act="relu", plain_last = False, bias=True)
