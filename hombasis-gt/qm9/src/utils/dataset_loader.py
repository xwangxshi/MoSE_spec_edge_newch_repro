...
from datasets import ProximityDataset #EDITED (got got rid of "utils" following "from")
from torch_geometric.datasets import TUDataset
from shortest_paths import ShortestPathTransform #EDITED (got got rid of "utils" following "from")
import numpy as np
