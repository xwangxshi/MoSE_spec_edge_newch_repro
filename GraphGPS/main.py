...
if __name__ == '__main__':
    ...
    # Load config file
    set_cfg(cfg)
    cfg.set_new_allowed(True) #DEBUG
    load_cfg(cfg, args)
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        loaders = create_loader() if not (hasattr(cfg.dataset, "follow_edge_batch") and cfg.dataset.follow_edge_batch) else custom_create_loader() #edit to accomodate following edge_attr_batch
