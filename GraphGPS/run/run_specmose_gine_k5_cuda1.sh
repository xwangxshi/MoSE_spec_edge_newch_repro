...
CFG="$GRAPHGPS/configs/ZINC/With_Edge_Features/GINe/+specmose.yaml"
...
CAMPAIGN=${1:-"$GRAPHGPS/results_specmose_gine_k5_20260821"}
SEEDS=(0 14 48 96)
...
SOURCE_FILES=(
  GraphGPS/configs/ZINC/With_Edge_Features/GINe/+specmose.yaml
  ...
  GraphGPS/run/run_specmose_gine_k5_cuda1.sh
