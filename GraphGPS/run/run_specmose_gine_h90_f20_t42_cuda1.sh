...
CFG="$GRAPHGPS/configs/ZINC/With_Edge_Features/GINe/+specmose-h90-f20-t42.yaml"
...
CAMPAIGN=${1:-"$GRAPHGPS/results_specmose_gine_h90_f20_t42_20260821"}
SEEDS=(0 14 48 96)
...
SOURCE_FILES=(
  GraphGPS/configs/ZINC/With_Edge_Features/GINe/+specmose-h90-f20-t42.yaml
  ...
  GraphGPS/run/run_specmose_gine_h90_f20_t42_cuda1.sh
